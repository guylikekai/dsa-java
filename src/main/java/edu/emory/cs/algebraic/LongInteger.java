...
public class LongInteger extends SignedNumeral<LongInteger> implements Comparable<LongInteger> {
    ...
    /**
     * Creates a long integer with the speciic sign and values.
     ...
     * @throws InvalidParameterException when 'n' contains non-digit character except for first character that can be
     * [+-\d]
     */
