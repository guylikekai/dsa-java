...
public class LongIntegerTest {
    ...
    public void testAddDifferentSign() {
        ...
        a.addDifferentSign(new LongIntegerQuiz("-1"));
        assertEquals("123456788", a.toString());

        a = new LongIntegerQuiz("123456789");
        a.addDifferentSign(new LongIntegerQuiz("-12345"));
        assertEquals("123444444", a.toString());

        a = new LongIntegerQuiz("123456789");
        a.addDifferentSign(new LongIntegerQuiz("-123456789"));
        assertEquals("0", a.toString());

        a = new LongIntegerQuiz("123456789");
        a.addDifferentSign(new LongIntegerQuiz("-1234567890123456789"));
        assertEquals("-1234567890000000000", a.toString());

        a = new LongIntegerQuiz("123456789");
        a.addDifferentSign(new LongIntegerQuiz("-0"));
        assertEquals("123456789", a.toString());
        ...
        a = new LongIntegerQuiz("123456789");
        a.add(new LongIntegerQuiz("-12345"));
        assertEquals("123444444", a.toString());
        ...
        a = new LongIntegerQuiz("123456789");
        a.add(new LongIntegerQuiz("-1234567890123456789"));
        assertEquals("-1234567890000000000", a.toString());
